...
%DIF ADD Manu_article_V2.tex   Wed Aug  4 15:04:28 2021
...
model to avoid running more models on smaller datasets with less power
as well as multiple testings. }\DIFaddend CA and biplots were conducted and
generated by the following packages under R environment (R Core Team,
2019): \texttt{FactoMineR, factoextra, ggplot2, ggrepel} (Lê et al.,
2008; Kassambara and Mundt, 2019; Wickham, 2016; Slowikowski, 2019)
Logistic regression models with GEE were performed with SAS procedure
...
study design. \DIFaddbegin \DIFadd{Our findings do not implicate whether it would be better
...
Moreover, }\DIFaddend The inability to assess the temporal relationship between
...
\begin{figure}[!ht]
\begin{center}
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=21.5cm]{Fig1.jpg}
%DIFDELCMD < %%%
...
\begin{figure}[!ht]
\begin{center}
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=21.5cm]{Fig2.jpg}
%DIFDELCMD < %%%
...
\begin{figure}[!ht]
\begin{center}
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=21.5cm]{Fig3.jpg}
%DIFDELCMD < %%%
...
\begin{figure}[!ht]
\begin{center}
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=21.5cm]{Fig4.jpg}
%DIFDELCMD < %%%
...
\begin{figure}[!ht]
\begin{center}
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=21.5cm]{Fig5.jpg}
%DIFDELCMD < %%%
