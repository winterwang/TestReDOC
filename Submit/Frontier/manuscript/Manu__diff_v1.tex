...
%DIF DEL Manu_article.tex      Tue Jun 22 11:46:06 2021
%DIF ADD Manu_article_V1.tex   Tue Jun 22 15:34:06 2021
...
Time of eating has been shown to be associated with diabetes and obesity but little is known about less healthy foods and specific time of their intake over the 24 hours of the day. In this study we aimed to identify potential relationships between foods and their eating time, and see whether these associations may vary by diabetes status. The National Diet and Nutrition Survey (NDNS) including 6802 adults (age $\geq$ 19 years old) collected 749,026 food recordings by a 4-day-diary. The contingency table cross-classifying 60 food groups with 7 pre-defined eating time slots (6-9am, 9am-12pm, 12-2pm, 2-5pm, 8-10pm, 10pm-6am) was analyzed by Correspondence Analysis (CA). CA biplots displaying the associations were generated for all adults and separately by diabetes status (self-reported, pre-diabetes, undiagnosed-diabetes, and non-diabetics) to visually explore the associations between food groups and time of eating across diabetes strata. For selected food groups, odds ratios (OR, 99\% confidence intervals, CI) were derived of consuming unhealthy foods at evening/night (8pm-6am) vs. earlier time in the day, by logistic regression models with generalized estimating equations. The biplots suggested positive associations between evening/night and consumption of puddings, regular soft drinks, sugar confectioneries, chocolates,  \DIFdelbegin \DIFdel{spirits, }\DIFdelend beers, ice cream, biscuits, and crisps for all adults in the UK. The OR (99\% CIs) of consuming these foods at evening/night were respectively \DIFdelbegin \DIFdel{1.38 (1.03, 1.86), 1.74 (1.47, 2.06), 1.92 (1.38, 2.69), 3.19 (2.69, 3.79), 11.13 (8.37, 14.80), 7.19 (5.87, 8.82), 2.38 (1.79, 3.15), 1.91 (1.67}\DIFdelend \DIFaddbegin \DIFadd{1.43 (1.06, 1.94), 1.72 (1.44, 2.05), 1.84 (1.31, 2.59), 3.08 (2.62, 3.62), 7.26 (5.91, 8.92), 2.45 (1.84, 3.25), 1.90 (1.68}\DIFaddend , 2.16), \DIFdelbegin \DIFdel{1.55 (1.27, 1.88}\DIFdelend \DIFaddbegin \DIFadd{1.49 (1.22, 1.82}\DIFaddend ) vs. earlier time in the day \DIFaddbegin \DIFadd{adjusted for age, sex, body mass index, and social-economic levels}\DIFaddend . Stratified biplots found that sweetened beverages, sugar-confectioneries appeared more strongly associated with evening/night among un-diagnosed diabetics. Foods consumed in the evening/night time tend to be highly processed, easily accessible, and rich in added sugar or saturated fat. Individuals with undiagnosed diabetes are more likely to consume unhealthy foods at night. Further longitudinal studies are required to ascertain the causal direction of the association between late-eating and diabetes status.
\tiny
...
night shifts (Bonnell et al., 2017; Balieiro et al., 2014). \DIFaddbegin \DIFadd{Previous
...
population (Almoosawi et al., 2014). }\DIFaddend Identifying those unhealthy foods
...
weight loss or glycemic control. Dietary diary recordings from \DIFdelbegin \DIFdel{national }\DIFdelend \DIFaddbegin \DIFadd{NDNS RP
}\DIFaddend surveys can provide detailed food choice data for exploration of the
...
\DIFdelbegin \DIFdel{Rolling Programme of the UK National Diet and Nutrition Survey }\DIFdelend \DIFaddbegin \DIFadd{NDNS RP }\DIFaddend from 2008 to 2017 as this survey includes diet diaries providing
...
collected by the \DIFdelbegin \DIFdel{UK National Diet and Nutrition Survey Rolling Programme
(}\DIFdelend NDNS RP 2008-17 \DIFdelbegin \DIFdel{) }\DIFdelend were analyzed in the current study (MRC
...
al., 2014; Roberts et al., 2018). \DIFdelbegin \DIFdel{Time }\DIFdelend \DIFaddbegin \DIFadd{The NDNS-RP, funded by Public Health
...
from the Oxfordshire Research Ethics Committee. A four-day food diary
method was used in the NDNS RP to collect the detailed food items and
their time of consumption from participants. Comparison between the food
diary method and a repeated 24-hour recall questionnaire was performed
in a subset of study sample prior to the launch of the NDNS RP in 2008
and found that they were similar in terms of response rate as well as
the ability to collect correct nutrition intake data. And the four-day
food diary methos was adopted because it is considered to be more
flexible and adaptable to cover wide population age range in the survey.
More details can be found in the Appendix A of the official NDNS RP
study report (Bates et al., 2014; Roberts et al., 2018). Furthermore,
the same food diary methods is actually used in large studies conducted
in the UK, such as the the MRC National Survey of Health and Development
(NSHD) (1946 British Birth Cohort) (Price et al., 1997), the EPIC
Norfolk Study (Bingham et al., 2001), the UK Women's Cohort Study in
Leeds (Cade et al., 2004), and the Avon Longitudinal Study of Parents
and Children (ALSPAC) cohort (Glynn et al., 2005).
}

\DIFadd{In the food diary recordings, time }\DIFaddend of the day was categorized into 7
slots: 6-9 am, 9-12 noon, 12-2 pm, 2-5 pm, 5-8 pm, \DIFaddbegin \DIFadd{8-10 pm }\DIFaddend and 10 pm - 6
...
adults and separately according to their diabetes status. \DIFaddbegin \DIFadd{CA is a
statistical technique to explore relationships between categorical
variables in a two-dimensional contingency table. In the current
analysis context, CA is the technique to flag up those food groups that
have a similar or differed ``profile'' among many categories. The
``profile'' means the relative frequency of the consumption of one food
across different time in the day (or, symmetrically, the relative
frequency of consumption of different foods at one specific time
period). One simple example is that if about 77.8\% of all foods were
consumed during the day time (earlier than 8 pm), but only 23.5\% of
beer consumption were recorded during the day time, then we say beer has
a time ``profile'' different from the average food profile. CA can
produce biplots to visually show the chi-square deviation (inertia) of
food (and time) profiles from the average profile. These biplots use the
first two most informative dimensions to show the inertia of the
contingency table. The horizontal axis of the biplot represents the
direction along which the contingency table rows and columns show their
greatest deviations. The vertical axis represents the direction,
...
origin to each profile point represents its deviation from the average
profile. The distance between row (food) and column (time slots) profile
points and the direction in which they lie away from the origin is
indicating that they are associated with each other. The potential
association is greater if points are located in similar directions and
away from the origin.
}

\DIFaddend To account for the hierarchical structure of the data (food recorded by
...
\DIFaddbegin \DIFadd{body mass index (BMI) }\DIFaddend and socio-economic levels, which were deemed the
...
for puddings \DIFdelbegin \DIFdel{1.38 (1.03, 1.86}\DIFdelend \DIFaddbegin \DIFadd{1.43 (1.06, 1.94}\DIFaddend ), for regular soft drinks \DIFdelbegin \DIFdel{1.74 (1.47,
2.06}\DIFdelend \DIFaddbegin \DIFadd{1.72 (1.44,
2.05}\DIFaddend ), for sugar confectioneries \DIFdelbegin \DIFdel{1.92 }\DIFdelend \DIFaddbegin \DIFadd{1.84 }\DIFaddend (1.38, 2.69), for chocolates \DIFdelbegin \DIFdel{3.19
(2.69, 3.79), for spirits 11.13 (8.37, 14.80}\DIFdelend \DIFaddbegin \DIFadd{3.08
(2.62, 3.62}\DIFaddend ), for beers \DIFdelbegin \DIFdel{7.19 (5.87, 8.82}\DIFdelend \DIFaddbegin \DIFadd{7.26 (5.91, 8.92}\DIFaddend ), for ice cream \DIFdelbegin \DIFdel{2.38 (1.79,
3.15}\DIFdelend \DIFaddbegin \DIFadd{2.45 (1.84,
3.25}\DIFaddend ), for biscuits \DIFdelbegin \DIFdel{1.91 (1.67}\DIFdelend \DIFaddbegin \DIFadd{1.90 (1.68}\DIFaddend , 2.16), for crisps \DIFdelbegin \DIFdel{1.55 (1.27, 1.88}\DIFdelend \DIFaddbegin \DIFadd{1.49 (1.22, 1.82}\DIFaddend )
...
\DIFdelbegin \DIFdel{1.50 (1.10, 2.07), 0.89 (0.16, 4.87), 1.81
}\DIFdelend \DIFaddbegin \DIFadd{1.55 (1.13, 2.15), 0.95 (0.17, 5.20), 1.82 }\DIFaddend (0.41, \DIFdelbegin \DIFdel{7.98}\DIFdelend \DIFaddbegin \DIFadd{8.03}\DIFaddend ), and \DIFdelbegin \DIFdel{0.58 (0.14,
2.43}\DIFdelend \DIFaddbegin \DIFadd{0.63 (0.15,
2.66}\DIFaddend ) for healthy, prediabetic, undiagnosed diabetic, and diabetic
...
drinks (OR: \DIFdelbegin \DIFdel{2.72}\DIFdelend \DIFaddbegin \DIFadd{2.82}\DIFaddend ; 99\% CI: \DIFdelbegin \DIFdel{1.44, 5.14}\DIFdelend \DIFaddbegin \DIFadd{1.24, 6.43}\DIFaddend ), and sugar confectioneries (OR:
\DIFdelbegin \DIFdel{13.07}\DIFdelend \DIFaddbegin \DIFadd{10.61}\DIFaddend ; 99\%CI: \DIFdelbegin \DIFdel{4.59, 37.24}\DIFdelend \DIFaddbegin \DIFadd{2.35, 47.04}\DIFaddend ) during night time periods compared to
...
These findings are concerning considering previous research \DIFdelbegin \DIFdel{that }\DIFdelend have
...
meals in the morning. (Wolever et al., 1988) \DIFaddbegin \DIFadd{One prospective study
...
having their time of last eating episode between 16:00 and 21:00.
(Faerch et al., 2019) }\DIFaddend More recently, a randomized controlled trial
indicated that consuming carbohydrates at dinner irrespective of
glycaemic index raised postprandial glucose response to breakfast
producing what is known as a second meal effect (Haldar et al., 2020).
Similar observation have been made by Nitta and colleagues who observed
that eating sweet snacks post-dinner worsened glycaemic excursions in
the evening and at subsequent breakfast (Nitta et al., 2019). Added to
this is evidence that suggests that the late-night dinners induce
post-prandial hyperglycemia in patients with type 2 diabetes and that
interventions at this eating occassions can result in a profound impact
on post-prandial glycaemia. On the balance of this evidence, targeting
and improving the timing and quality of foods in evening eating
occasions provides a unique opportunity to design intervention to those
...
modifications. \DIFdelbegin %DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{Food intake late in the night is in misalignment with the
...
Kadowaki et al., 2018; Reutrakul et al., 2014). }\DIFaddend Assessing the
...
times). \DIFaddbegin \DIFadd{Finally, we did not include variables indicating abdominal
...
sugar or saturated fat, whatever the diabetic status. \DIFdelbegin \DIFdel{. }\DIFdelend Individuals with
...
\begin{table}[h!]
    \caption{The \DIFdelbeginFL \DIFdelFL{numbers of }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{top 37 }\DIFaddendFL food \DIFdelbeginFL \DIFdelFL{recordings }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{groups sorted by increasing cumulative percentages which }\DIFaddendFL contributed to \DIFaddbeginFL \DIFaddFL{90\% of }\DIFaddendFL the total calories consumed by \DIFdelbeginFL \DIFdelFL{adults in }\DIFdelendFL the UK adults. (NDNS RP 2008-2017).}
...
%DIFDELCMD <         Selected food groups & Overall             & Healthy             & Pre-diabetics      & Undiagnosed diabetes & Diabetes            \\\hline
%DIFDELCMD <         Pudding              & 1.38 (1.03, 1.86)   & 1.50 (1.10, 2.07)   & 0.89 (0.16, 4.87)  & 1.81 (0.41, 7.98)    & 0.58 (0.14, 2.43)   \\
%DIFDELCMD <         Regular soft drink   & 1.74 (1.47, 2.06)   & 1.72 (1.43, 2.06)   & 1.87 (0.97, 3.57)  & 2.72 (1.44, 5.14)    & 1.38 (0.65, 2.96)   \\
%DIFDELCMD <         Sugar Confectionery  & 1.92 (1.38, 2.69)   & 1.63 (1.14, 2.32)   & 2.10 (0.52, 8.46)  & 13.07 (4.59, 37.24)  & 5.10 (2.15, 12.09)  \\
%DIFDELCMD <         Chocolate            & 3.19 (2.69. 3.79)   & 3.10 (2.57, 3.73)   & 4.07 (2.58, 3.73) (2.02, 8.20)  & 2.52 (0.95, 6.66)    & 5.13 (2.55, 10.30)  \\
%DIFDELCMD <         Spirit               & 11.13 (8.37, 14.80) & 10.86 (8.01, 14.73) & 8.48 (2.26, 31.79) & 7.51 (1.99, 5.21)    & 36.8 (7.36, 183.66) \\
%DIFDELCMD <         Beer                 & 7.19 (5.87, 8.82)   & 7.49 (6.02, 9.34)   & 4.05 (2.00, 8.20)  & 7.87 (3.51, 17.63)   & 6.32 (2.29, 17.47)  \\
%DIFDELCMD <         Ice Cream            & 2.38 (1.79, 3.15)   & 2.45 (1.82, 3.31)   & 3.32 (0.75, 14.62) & 0.98 (0.14, 7.00)    & 1.65 (0.54, 5.07)   \\
%DIFDELCMD <         Biscuit              & 1.91 (1.67, 2.16)   & 1.78 (1.55, 2.03)   & 3.51 (2.16, 5.71)  & 2.75 (1.35, 5.59)    & 2.44 (1.54, 3.88)   \\
%DIFDELCMD <         Crisp                & 1.55 (1.27, 1.88)   & 1.56 (1.27, 1.92)   & 1.95 (0.79, 4.78)  & 1.37 (0.37, 5.12)    & 1.16 (0.49, 2.75)   \\\hline
%DIFDELCMD <         \multicolumn{6}{l}{Logistic regression models with GEE were adjusted for age, sex, and social-economic levels.}  \\
%DIFDELCMD <                 \multicolumn{6}{l}{NDNS RP: National Diet and Nutrition Survey. }             
...
\leavevmode\DIFaddbegin \hypertarget{ref-almoosawi2014biomarkers}{}%DIF > 
\DIFadd{Almoosawi, S., Cole, D., Nicholson, S., Bayes, I., Teucher, B., Bates,
B., Mindell, J., Tipping, S., Deverill, C., and Stephen, A. (2014).
Biomarkers of diabetes risk in the national diet and nutrition survey
rolling programme (2008--2011). }\emph{\DIFadd{J Epidemiol Community Health}} \DIFadd{68,
51--56.
}

\leavevmode\DIFaddend \hypertarget{ref-almoosawi2016chrono}{}%
...
\leavevmode\DIFaddbegin \hypertarget{ref-bingham2001nutritional}{}%DIF > 
\DIFadd{Bingham, S. A., Welch, A. A., McTaggart, A., Mulligan, A. A., Runswick,
S. A., Luben, R., Oakes, S., Khaw, K. T., Wareham, N., and Day, N. E.
(2001). Nutritional methods in the european prospective investigation of
cancer in norfolk. }\emph{\DIFadd{Public health nutrition}} \DIFadd{4, 847--858.
}

\leavevmode\DIFaddend \hypertarget{ref-bonnell2017influences}{}%
...
\leavevmode\DIFaddbegin \hypertarget{ref-cade2004uk}{}%DIF > 
\DIFadd{Cade, J. E., Burley, V. J., Greenwood, D. C., Group, U. W. C. S. S., and
others (2004). The UK women's cohort study: Comparison of vegetarians,
fish-eaters and meat-eaters. }\emph{\DIFadd{Public health nutrition}} \DIFadd{7, 871--878.
}

\leavevmode\DIFaddend \hypertarget{ref-Chapman2017}{}%
...
\leavevmode\DIFaddbegin \hypertarget{ref-faerch2019prospective}{}%DIF > 
\DIFadd{Faerch, K., Quist, J. S., Hulman, A., Witte, D., Tabak, A., Brunner, E.,
...
}\emph{\DIFadd{Diabetic Medicine}} \DIFadd{36, 1256--1260.
}

\leavevmode\DIFaddend \hypertarget{ref-FayetMoore2017}{}%
...
\leavevmode\DIFaddbegin \hypertarget{ref-glynn2005food}{}%DIF > 
\DIFadd{Glynn, L., Emmett, P., Rogers, I., and Team, A. S. (2005). Food and
...
}\emph{\DIFadd{Journal of Human Nutrition and Dietetics}} \DIFadd{18, 7--19.
}

\leavevmode\DIFaddend \hypertarget{ref-greenacre2017correspondence}{}%
...
\leavevmode\DIFaddbegin \hypertarget{ref-kadowaki2018relationship}{}%DIF > 
\DIFadd{Kadowaki, T., Haneda, M., Ito, H., Sasaki, K., Hiraide, S., Matsukawa,
...
}\emph{\DIFadd{Advances in Therapy}} \DIFadd{35, 817--831.
}

\leavevmode\DIFaddend \hypertarget{ref-factoextra}{}%
...
\leavevmode\DIFaddbegin \hypertarget{ref-price1997characteristics}{}%DIF > 
\DIFadd{Price, G., Paul, A., Cole, T., and Wadsworth, M. J. (1997).
Characteristics of the low-energy reporters in a longitudinal national
dietary survey. }\emph{\DIFadd{British Journal of Nutrition}} \DIFadd{77, 833--851.
}

\leavevmode\DIFaddend \hypertarget{ref-Rcoreteam}{}%
R Core Team (2019). \emph{R: A language and environment for statistical
computing}. Vienna, Austria: R Foundation for Statistical Computing
Available at: \url{https://www.R-project.org/}.

\leavevmode\DIFaddbegin \hypertarget{ref-reutrakul2014relationship}{}%DIF > 
\DIFadd{Reutrakul, S., Hood, M. M., Crowley, S. J., Morgan, M. K., Teodori, M.,
and Knutson, K. L. (2014). The relationship between breakfast skipping,
chronotype, and glycemic control in type 2 diabetes. }\emph{\DIFadd{Chronobiology
international}} \DIFadd{31, 64--71.
}

\leavevmode\DIFaddend \hypertarget{ref-roberts2018national}{}%
...
SAS Institute Inc\DIFaddbegin \DIFadd{.
}

\leavevmode\hypertarget{ref-sato2011acute}{}%DIF > 
\DIFadd{Sato, M., Nakamura, K., Ogata, H., Miyashita, A., Nagasaka, S., Omi, N.,
...
energy metabolism. }\emph{\DIFadd{Obesity research \& clinical practice}} \DIFadd{5,
e220--e228}\DIFaddend .
