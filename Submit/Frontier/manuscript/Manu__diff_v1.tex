...
%DIF ADD Manu_article_V1.tex   Wed Jun 30 09:22:02 2021
...
\newcommand{\blandscape}{\begin{landscape}} %DIF > 
\newcommand{\elandscape}{\end{landscape}} %DIF > 
%DIF -------
...
\DIFadd{A four-day food diary method was used in the NDNS RP to collect the
...
\DIFadd{In the current analysis context, CA was used as a tool to visually
...
dinner (5 pm - 8 pm: 24.1\%) time slots\DIFaddbegin \DIFadd{, more details can be found in
Supplementary Table S1}\DIFaddend . Table 1. shows the top 37 food groups that
...
side of the plot closer to alcoholic products \DIFdelbegin \DIFdel{(beers and spirits) }\DIFdelend or highly
...
al., 2019) }\DIFaddend More recently, a randomized controlled trial indicated that
...
\leavevmode\DIFaddbegin \hypertarget{ref-Lennoxappx}{}%DIF > 
\DIFadd{Lennox, A., Bluck, L., Page, P., Pell, D., Cole, D., Ziauddeen, N.,
Steer, T., Nicholson, S., Goldberg, G., and Prentice, A. Appendix }{\DIFadd{X}}\DIFadd{:
}{\DIFadd{M}}\DIFadd{isreporting in the }{\DIFadd{N}}\DIFadd{ational }{\DIFadd{D}}\DIFadd{iet and }{\DIFadd{N}}\DIFadd{utrition }{\DIFadd{S}}\DIFadd{urvey
}{\DIFadd{R}}\DIFadd{olling }{\DIFadd{P}}\DIFadd{rogramme (}{\DIFadd{NDNS RP}}\DIFadd{): Summary of results and their
interpretation. Available at:
}\url{https://fsa-catalogue2.s3.eu-west-2.amazonaws.com/ndns-appendix-x.pdf}\DIFadd{.
}

\leavevmode\DIFaddend \hypertarget{ref-L__2008}{}%
...
National \DIFdelbegin \DIFdel{diet and nutrition survey years }\DIFdelend \DIFaddbegin {\DIFadd{D}}\DIFadd{iet and }{\DIFadd{N}}\DIFadd{utrition }{\DIFadd{S}}\DIFadd{urvey }{\DIFadd{Y}}\DIFadd{ears }\DIFaddend 1-8, 2008/09-2015/16
{[}data collection{]}.
doi:\DIFdelbegin %DIFDELCMD < \href{https://doi.org//url\%7B10.5255/ukda-sn-6533-11\%7D}{\textbackslash url\{10.5255/ukda-sn-6533-11\}}%%%
\DIFdelend \DIFaddbegin \href{https://doi.org/10.5255/ukda-sn-6533-11}{10.5255/ukda-sn-6533-11}\DIFaddend .
...
College London. Medical School. (2018). National \DIFdelbegin \DIFdel{diet and nutrition
survey }\DIFdelend \DIFaddbegin {\DIFadd{D}}\DIFadd{iet and }{\DIFadd{N}}\DIFadd{utrition
}{\DIFadd{S}}\DIFadd{urvey }\DIFaddend years 1-8, 2008/09-2015/16.
...
\leavevmode\DIFaddbegin \hypertarget{ref-sato2011acute}{}%DIF > 
...
\leavevmode\DIFaddend \hypertarget{ref-ggrepel}{}%
...
\section*{\DIFadd{Figure captions}}

\begin{figure}[!ht]
\begin{center}
\includegraphics[width=21.5cm]{Fig1.jpg}
\end{center}
\caption{\DIFaddFL{Biplot of food groups and eating time slots in the total sample in the NDNS RP.}}\label{fig:fig1}
\end{figure}
...
\end{center}
\caption{\DIFaddFL{Biplot of food groups and eating time slots in non-diabetic participants in the NDNS RP.}}\label{fig:fig2}
\end{figure}
...
\end{center}
\caption{\DIFaddFL{Biplot of food groups and eating time slots in diabetic participants in the NDNS RP.}}\label{fig:fig3}
\end{figure}
...
\end{center}
\caption{\DIFaddFL{Biplot of food groups and eating time slots in undiagnosed diabetic participants in the NDNS RP.}}\label{fig:fig4}
\end{figure}
...
\end{center}
\caption{\DIFaddFL{Biplot of food groups and eating time slots in pre-diabetic participants in the NDNS RP.}}\label{fig:fig5}
\end{figure}
