...
to earlier in the day (in the morning or afternoon). In the fixed effect
...
as well as multiple testings. CA and biplots were conducted and
...
participants with other diabetes status. The same models were also used
...
The Supplementary Table S1 \& Table S2 for this article can be found
online at: xxxx
