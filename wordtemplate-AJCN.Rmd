...
An important limitation in this study is the cross-sectional study design. The inability to assess the temporal relationship between timing of food intake and diabetes status means that a cause-effect relationship between time of unhealthy food intake and diabetes status cannot be established. Hence, further prospecitive studies are warranted to investigate the temporal relationship between diabetes and other disease status in relation to both quality and timing of eating. Moreover, the current study assumes that mis-reporting occured equally amongst all eating occasions. This limitation has been reported by previous research and is a limitation of chrono-nutrition. [@FayetMoore2017]
